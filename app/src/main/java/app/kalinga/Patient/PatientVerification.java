...
public class PatientVerification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new_file_layout = findViewById(R.id.patient_ver_new_file_layout);
        new_file = findViewById(R.id.patient_ver_new_file_name_empty);
        x_con = findViewById(R.id.patient_ver_new_file_x_icon);
        filename = findViewById(R.id.patient_ver_filename);
        verification_policy = findViewById(R.id.patient_ver_checkbox);
        proceed = findViewById(R.id.patient_ver_proceed);
        back = findViewById(R.id.patient_ver_back);
